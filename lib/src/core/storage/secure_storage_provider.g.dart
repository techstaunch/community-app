...
final class AuthStorageProvider
    extends $AsyncNotifierProvider<AuthStorage, void> {
...
String _$authStorageHash() => r'c74eb5683a9d58c85f4ccc7f531699aa18a0aabd';

abstract class _$AuthStorage extends $AsyncNotifier<void> {
  FutureOr<void> build();
  @$mustCallSuper
  @override
